...
def solution(src, dest):
    ...
    while True:
        ...
        for location in level_count[level - 1]:
            if check_visited(is_visited, (location[0], location[1])):
                continue
            is_visited.append((location[0], location[1]))
